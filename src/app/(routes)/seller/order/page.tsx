...
export default function SellerCreateOrderPage() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col gap-6 bg-neutral-50/50 p-4 md:p-8 pb-36 lg:pb-12">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div className="flex items-center gap-3">
          <Button
            ...
            size="icon"
            onClick={() => router.back()}
            className="h-10 w-10 rounded-xl border-neutral-200 text-neutral-600 hover:bg-neutral-100 cursor-pointer shrink-0"
          >
            <ArrowLeft className="size-5" />
          </Button>
          <div>
            <h1 className="bg-gradient-to-r from-blue-900 to-blue-700 bg-clip-text text-2xl md:text-3xl font-extrabold tracking-tight text-transparent flex items-center gap-2">
              <ClipboardList className="size-7 text-blue-600" />
              Tomar Pedido
            </h1>
            <p className="text-xs md:text-sm font-medium text-neutral-500 mt-0.5">
              Registra un nuevo pedido para los clientes de tu cartera de ventas.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="rounded-2xl border border-neutral-100 bg-white p-5 md:p-6 shadow-xs flex flex-col gap-4">
            <div className="flex items-center gap-2 pb-3 border-b border-neutral-50">
              ...
              <h2 className="text-sm font-extrabold text-neutral-800">
                1. Zona y Cliente de tu Cartera
              </h2>
            </div>
              ...
              {zone ? (
                ...
                <div className="p-3 bg-neutral-50 rounded-xl border border-dashed border-neutral-200 text-center">
                  <p className="text-xs text-neutral-400 font-medium">
                    Selecciona una de tus zonas asignadas para ver los clientes disponibles.
                  </p>
                </div>
              )}
            </div>
            ...
            {!client ? (
              <div className="p-6 bg-neutral-50/70 rounded-2xl border border-dashed border-neutral-200 text-center flex flex-col items-center">
                <p className="text-xs font-semibold text-neutral-500">
                  Selecciona la zona y el cliente para habilitar el selector de productos.
                </p>
              </div>
            ) : (
              <div className="flex items-center justify-between p-3.5 bg-blue-50/30 rounded-xl border border-blue-100/60">
                <p className="text-xs text-neutral-600 font-medium">
                  Elige los portafolios y agrega los productos por bultos a este pedido.
                </p>
          ...
          <div className="rounded-2xl border border-neutral-100 bg-white p-5 md:p-6 shadow-xs flex flex-col gap-3">
            <div className="flex items-center gap-2 pb-2 border-b border-neutral-50">
              ...
              <Label htmlFor="order-note" className="text-sm font-extrabold text-neutral-800">
                3. Notas de Entrega / Despacho (Opcional)
              </Label>
            </div>
            <textarea
              id="order-note"
              placeholder="Añade instrucciones de despacho, horario de recepción o requerimientos del cliente..."
        ...
        <div className="lg:col-span-5 flex flex-col gap-5 lg:sticky lg:top-6">
          <div className="rounded-2xl border border-neutral-100 bg-white p-5 md:p-6 shadow-xs flex flex-col gap-5">
            ...
            <div className="pt-2">
              <CreateOrderBtn redirectPath="/seller/history" />
            </div>
          </div>
        </div>
      ...
      {detailsCount > 0 && (
        <div className="lg:hidden fixed bottom-16 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-neutral-200 p-4 shadow-xl flex items-center justify-between gap-3 animate-in slide-in-from-bottom duration-200">
          ...
          <div className="flex-1 max-w-[200px]">
            <CreateOrderBtn redirectPath="/seller/history" className="py-2.5 text-xs" />
          </div>
        </div>
      )}
    </div>
