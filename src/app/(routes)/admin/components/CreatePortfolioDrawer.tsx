    ...
    <DrawerCreate trigger="Crear Portafolio">
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 py-4">
        ...
        <DrawerFooter className="px-0 pt-4">
          <DrawerClose asChild>
            <Button
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium shadow-md transition-all duration-200"
              type="submit"
            >
              Guardar Portafolio
            </Button>
